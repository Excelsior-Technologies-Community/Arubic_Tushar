  ...
  return (
    <div className="pc-stars">
      {[1, 2, 3, 4, 5].map((star) => (
        <span
          key={star}
          className={star <= rating ? "pc-star pc-star-filled" : "pc-star"}
        >
          ★
        </span>
      ))}
...
const ProductCatalog = () => {
  ...
  if (loading) {
    return <p className="pc-status">Loading...</p>;
  }

  if (error) {
    return <p className="pc-status pc-error">{error}</p>;
  }
    ...
    <>
        ...
        <div className="pc-wrapper">
          <div className="pc-col">
            <div className="pc-col-header">
              <h2>New Products</h2>
              <p>
                We offer the best selection fashion at prices you will love!
              </p>
            </div>
      ...
      <div className="feature-section">
        <div className="feature-content">
          <img
            src="https://htmldemo.net/arubic/arubic/img/feature/feature1.png"
            alt=""
          />
          <h1>Free Shipping</h1>
        ...
        <div className="feature-content">
          <img
            src="https://htmldemo.net/arubic/arubic/img/feature/feature2.png"
            alt=""
          />
  ...
  return (
    <div className="pc-large-card">
      <div className="pc-large-img-wrap">
        <img
          src={`http://localhost:5000${image1}`}
          alt={title}
          className="pc-large-img pc-img-main"
        />

        <img
          src={`http://localhost:5000${image2 || image1}`}
          alt={title}
          className="pc-large-img pc-img-hover"
        />
    ...
    <div className="pc-small-card">
      <div className="pc-small-img-wrap">
        <img
          src={`http://localhost:5000${image1}`}
          alt={title}
          className="pc-small-img pc-img-main"
        />

        <img
          src={`http://localhost:5000${image2 || image1}`}
          alt={title}
          className="pc-small-img pc-img-hover"
        />
      </div>
